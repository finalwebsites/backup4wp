    ...
    <div class="container outwrapper">
      <div class="starter-template">
        ...
        <form role="form" id="myform">
			...
			<p>Check which directories you like to exclude from the backup. Compressed files (.zip and .wpress) and the current directory (for example "mybackup") are always excluded!</p>
